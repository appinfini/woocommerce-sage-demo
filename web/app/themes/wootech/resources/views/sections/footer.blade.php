	...
	<script src="{{ get_template_directory_uri() }}/resources/scripts/jquery-3.6.0.min.js"></script>
	<script src="{{ get_template_directory_uri() }}/resources/scripts/alpine.min.js"></script>
	<script src="{{ get_template_directory_uri() }}/resources/scripts/jquery.validate.min.js"></script>
