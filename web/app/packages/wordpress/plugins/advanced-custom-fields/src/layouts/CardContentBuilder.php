...
class CardContentBuilder
{
    ...
    {        
        ...
        if (ThemeFunctions::hasValidArrayContents($behaviorSettings)) {
            ...
            // Add items.
            if (ThemeFunctions::hasValidArrayContents($behaviorSettings['section_cards'])) {
                foreach ($behaviorSettings['section_cards'] as $row) {
                    ...
                    $preparedRow = [
                        'heading' => !empty($row['section_heading'])
                            ? $row['section_heading']
                            : null,
                        'content' => !empty($row['content_list'])
                            ? $row['content_list']
                            : null,
                    ];
